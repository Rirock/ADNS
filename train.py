...
if __name__ == "__main__":
    ...
    parser.add_argument("-m", "--train_model", default="ADNM", type=str, help="use model")  # ICFC DNM_Linear
    ...
    # model_save_path = "./models_"+model_name
    # l_path = "./logs_"+model_name
    ...
    if "MLP" in model_name or "IC" in model_name or "Transformer" in model_name:
        ...
        model_save_path = os.path.join(model_save_path, data_name+"_"+model_name+"_"+str(hidden_size))
        ...
        model_save_path = os.path.join(model_save_path, data_name+"_"+model_name+"_"+str(hidden_size)+"_M"+str(M))
    elif "DNM_linear" in model_name or "ADNM" in model_name:
        net = eval(model_name+"(input_size, out_size, M).to(device)")
        log_path = os.path.join(log_path, model_name+"_"+str(hidden_size)+"_M"+str(M)+"_log.csv")
        model_save_path = os.path.join(model_save_path, data_name+"_"+model_name+"_M"+str(M))
    else:
    ...
    for run in range(run_times):
        ...
        for epoch in range(epochs):
            ...
            if current_val_acc > best_val_acc or current_val_loss<best_val_loss:
                ...
                save_path = model_save_path+"_"+str(run)+".pth"
    ...
    log_list = list(map(list, zip(*log_list)))  # Transfer
